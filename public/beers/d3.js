angular
    .module("SOS161710")
    .controller("D3Beers", ["$http", function($http) {
        console.log("Controller initalized");
            ...
            function histoGram(fD) {
                ...
                function mouseover(d) { // utility function to be called on mouseover.
                    ...
                    var st = fData.filter(function(s) {
                            return s.Country == d[0];
                        })[0],
                        nD = d3.keys(st.datas).map(function(s) {
                            return {
                                type: s,
                                datas: st.datas[s]
                            };
            ...
            function pieChart(pD) {
                ...
                function mouseover(d) {
                    ...
                    hG.update(fData.map(function(v) {
                        return [v.Country, v.datas[d.data.type]];
